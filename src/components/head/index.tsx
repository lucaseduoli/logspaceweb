          ...
          <div className="flex w-full mx-auto text-left lg:mt-16">
            <div className="relative flex flex-col items-center m-auto align-middle">
              ...
              <div className="flex w-full max-w-2xl gap-2 mt-10 lg:justify-center lg:mx-auto">
                <div
                  className="mt-3 rounded-xl bg-gradient-to-r 
                    from-[#64abb8] via-[#475dc2] to-[#5b51c4] animate-text p-1 sm:mt-0 sm:ml-3"
                >
                  <a
                    href="mailto:contact@logspace.ai"
                    className="items-center bg-pearl block px-8 py-2.5 text-base font-medium text-center text-white transition duration-500 ease-in-out transform rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:bg-white hover:text-majorelly"
                  >
                    Schedule A Meeting
                  </a>
                </div>
