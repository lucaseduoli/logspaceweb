...
export default function Head() {
  return (
    <section className="relative w-full">
      <div className="relative items-center w-full px-5 py-40 mx-auto md:px-12 lg:px-16 max-w-7xl">
      ...
      <div className="relative mt-52 items-center text-center hidden w-full px-5 mb-32 mx-auto md:px-12 lg:px-16 lg:block">
